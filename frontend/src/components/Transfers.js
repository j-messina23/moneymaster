        ...
        if (transferAmount <= 500) {
            try {
                ...
                if (transferAccountType === '1') {
                    setTransferMessage('$' + transferAmount + ' sent from Checking to Savings!')
                } else if (transferAccountType === '2') {
                    setTransferMessage('$' + transferAmount + ' sent from Savings to Checking!')
                }
            }
            catch (e) {
                console.log(e.toString())
                    ...
                    {switchForms ? (
                        <div className="h-full flex flex-col justify-around">
                            ...
                            {transferSuccess === 'True' && (
                                ...
                                <div className="w-full items-center flex justify-evenly py-3">
